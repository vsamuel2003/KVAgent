...
DEFAULT_LLM_AGENT = "Qwen/Qwen3-4B-Instruct-2507"
DEFAULT_LLM_USER = "Qwen/Qwen3-4B-Instruct-2507"
DEFAULT_LLM_TEMPERATURE_AGENT = 0.7
DEFAULT_LLM_TEMPERATURE_USER = 0.7
...
DEFAULT_LLM_NL_ASSERTIONS = "Qwen/Qwen3-4B-Instruct-2507"
DEFAULT_LLM_NL_ASSERTIONS_TEMPERATURE = 0.7
DEFAULT_LLM_NL_ASSERTIONS_ARGS = {"temperature": DEFAULT_LLM_NL_ASSERTIONS_TEMPERATURE}

DEFAULT_LLM_ENV_INTERFACE = "Qwen/Qwen3-4B-Instruct-2507"
DEFAULT_LLM_ENV_INTERFACE_TEMPERATURE = 0.7
